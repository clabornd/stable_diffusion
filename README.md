...
│
├── pyproject.toml     <- Project configuration file with package metadata for stable_diffusion
...
│
└── stable_diffusion                <- Source code for use in this project.
    │
    ├── __init__.py    <- Makes stable_diffusion a Python module
    │
